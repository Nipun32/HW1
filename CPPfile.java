...
public class CPPfile 
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		File file=new File("E:\\java_data\\hw3\\keywords.txt");
		...
		file=new File("E:\\java_data\\hw3\\HW3-input-code.cpp");
		
		sc=new Scanner(file);	//file scanned
		
		//Output file "HW3-output-16103048.txt" opened  
		PrintWriter fout=new PrintWriter("HW3-output-16103048.txt");
